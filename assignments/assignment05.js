    ...
    if (!localStorage.getItem("date") || dayjs().valueOf() - localStorage.getItem("date") > 86400000) {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 &&
                ...
                for (let c of covidJsObj.Countries)
                    ...
                    if (c.TotalDeaths > 50000) {
                        newConfirmedOver1000.push({
                            ...
                            //STEP 2 Create array of objects containing slug, totalconfirmed, totaldeaths, population, and totalconfirmed
                ...
                chartData.data.datasets[0].label = 'Total Cases'; //changed from new cases to Total Cases
                chartData.data.datasets[1].label = 'Total Deaths'; //changed from new deaths to Total Deaths
